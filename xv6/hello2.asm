...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a9:	0f b6 91 38 0a 00 00 	movzbl 0xa38(%ecx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 4e3:	75 25                	jne    50a <printf+0xff>
          s = "(null)";
 4e5:	c7 45 f4 ed 07 00 00 	movl   $0x7ed,-0xc(%ebp)
        while(*s != 0){
...
0000059d <free>:
 ...
 5ac:	a1 54 0a 00 00       	mov    0xa54,%eax
 ...
 677:	a3 54 0a 00 00       	mov    %eax,0xa54
 67c:	90                   	nop
 67d:	c9                   	leave  
 67e:	c3                   	ret    
...
0000067f <morecore>:
 ...
 6d8:	a1 54 0a 00 00       	mov    0xa54,%eax
 6dd:	c9                   	leave  
 6de:	c3                   	ret    
...
000006df <malloc>:
 ...
 6f4:	a1 54 0a 00 00       	mov    0xa54,%eax
 6f9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 6fc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 700:	75 23                	jne    725 <malloc+0x46>
 702:	c7 45 f0 4c 0a 00 00 	movl   $0xa4c,-0x10(%ebp)
 709:	8b 45 f0             	mov    -0x10(%ebp),%eax
 70c:	a3 54 0a 00 00       	mov    %eax,0xa54
 711:	a1 54 0a 00 00       	mov    0xa54,%eax
 716:	a3 4c 0a 00 00       	mov    %eax,0xa4c
 71b:	c7 05 50 0a 00 00 00 	movl   $0x0,0xa50
 722:	00 00 00 
